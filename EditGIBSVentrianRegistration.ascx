<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditGIBSVentrianRegistration.ascx.cs" Inherits="GIBS.Modules.GIBSVentrianRegistration.EditGIBSVentrianRegistration" %>
...
<table width="650" cellspacing="0" cellpadding="0" border="0" summary="Edit Table">
	<tr valign="top">
		...
		<td>
			<dnn:TextEditor id="txtContent" runat="server" height="600" width="500" HtmlEncode="False" />
